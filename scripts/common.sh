...
ADMIN_API_SERVICE="${ADMIN_API_SERVICE:-inatews-admin-api}"
INGEST_SERVICE_ACCOUNT="${INGEST_SERVICE_ACCOUNT:-inatews-ingest-sa}"
API_SERVICE_ACCOUNT="${API_SERVICE_ACCOUNT:-inatews-api-sa}"
ADMIN_API_SERVICE_ACCOUNT="${ADMIN_API_SERVICE_ACCOUNT:-inatews-admin-api-sa}"
DASHBOARD_SERVICE_ACCOUNT="${DASHBOARD_SERVICE_ACCOUNT:-inatews-dashboard-sa}"
